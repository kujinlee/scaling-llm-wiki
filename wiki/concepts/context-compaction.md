...
related: [context-decay, context-rot, persistent-agent-memory, lifecycle-hooks, progressive-disclosure-retrieval, claude-md, tool-output-virtualization]
sources: [12-claude-code-features-every-engineer-should-know-subagents, every-claude-code-memory-system-compared-so-you-don-t-have-t, claude-code-is-expensive-this-mcp-server-fixes-it-context-mo]
---
...
- **Manual vs. automatic timing**: deciding *when* to compact is a judgment call — too early wastes recoverable context, too late risks hitting the hard limit mid-task — the same escalation-threshold tuning problem seen in tiered retrieval.
